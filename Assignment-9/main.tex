...
\end{align}
considering the case with $a=1, b=1$, the joint probability distribution is given as
\begin{align}
f_Z(x,y)=\frac{\text{exp}\brak{-\frac{1}{2}\brak{z-\mu}^\top\Sigma^{-1}\brak{z-\mu}}}{\sqrt{(2\pi)^2\abs{\Sigma}}}\\
f_Z(x,y)=\frac{\text{exp}\brak{-\frac{1}{2}\brak{\begin{bmatrix} x &y\end{bmatrix}} I_2\brak{\begin{bmatrix} x &y\end{bmatrix}}^\top}}{\sqrt{(2\pi)^2}}
\end{align}
Where $I_2$ is the identity matrix of order 2
\begin{align}
f_Z(x,y)=\frac{\text{exp}\brak{-\frac{1}{2}\brak{\begin{bmatrix} x &y\end{bmatrix}} \brak{\begin{bmatrix} x &y\end{bmatrix}}^\top}}{\sqrt{(2\pi)^2}}\\
