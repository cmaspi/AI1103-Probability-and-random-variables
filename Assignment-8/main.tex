...
$(A)\frac{S_n}{n log\brak{n}}\to 0 \text{ as } n \to \infty$ with probability 1.\\\\
$(B)\pr{\brak{S_n>\frac{2n}{3}}\text{occurs for infinitely many n}}=1$\\\\
$(C)\frac{S_n}{log\brak{n}}\to 0\text{ as } n \to \infty$ with probability 1.\\\\
$(D)\pr{\brak{S_n>\frac{n}{3}}\text{occurs for infinitely many n}}=1$
\section{solution}
Given
\begin{align}
\displaystyle S_n=\sum_{i=1}^{n}X_i , n\ge 1
\end{align}
Dividing by $n$ on both sides, defining $\mu_n$ as follows
\begin{align}
\dfrac{S_n}{n}=\displaystyle\frac{1}{n} \sum_{i=1}^{n}X_i=\mu_n
\end{align}
Let X be an independent continuous variable identical to $X_1,X_2,...,X_n$\\
It can be said that $X_1,X_2,...,X_n$ are the trials of $X$, and $\mu_n$ represents arthimetic mean of outcomes.\\
By definition
\begin{align}
E\sbrak{X}=&\displaystyle \lim_{n\to \infty} \frac{\sum_{i=1}^{n}X_i}{n}=\lim_{n\to \infty} \frac{S_n}{n}\\
&\lim_{n\to \infty} \frac{S_n}{n}=\frac{1}{2} \label{eq:mu_value} \\
\therefore&\lim_{n\to \infty} \frac{S_n}{nlog\brak{n}}=0
\end{align}
